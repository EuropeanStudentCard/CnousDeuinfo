...
namespace DamWebService
{
    class DamRestCommand
    {
        ...
        public class JsonDamCreate
        {
            ...
            private string[] dmaauthkeyAsHex { get; set; }

            [JsonIgnore]
            public byte[] dmaauthkey { get => Converters.StringToByteArray(dmaauthkeyAsHex); set => dmaauthkeyAsHex = Converters.ByteArrayToStringArray(value); }
